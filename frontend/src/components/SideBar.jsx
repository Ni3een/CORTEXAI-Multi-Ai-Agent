    ...
    if (collapsed) {
        return (
            <div className="hidden lg:flex flex-col items-center w-[56px] h-screen bg-[#0d0f14] border-r border-white/[0.06] py-4 gap-1 shrink-0">
                ...
                {/* Conversations */}
                <div className="flex-1 w-full overflow-y-auto px-2 pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden pt-4">
                    {conversations.map((conv) => {
                        ...
                        return (
                            <button
                                ...
                                className={`w-full flex items-center justify-center mb-1 py-2 rounded-lg border transition-colors duration-150
                                ${
                                    isActive
